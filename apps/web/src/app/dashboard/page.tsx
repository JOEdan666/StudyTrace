...
export default function DashboardPage() {
  ...
  const summarizedCount = useMemo(
    () => records.filter((record) => record.status === 'summarized').length,
    [records]
  );

  const tagCount = useMemo(
    () => new Set(records.flatMap((record) => record.tags || [])).size,
    [records]
  );
    ...
    <>
      ...
      <div className="stats-row">
        ...
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">{loading ? '-' : summarizedCount}</div>
        ...
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">{loading ? '-' : tagCount}</div>
